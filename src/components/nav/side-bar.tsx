        ...
        <div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        <Link to="/profile">
                            <div className={`${Styles.itemClickable} ${currentPath === '/profile' ? Styles.open : ''}`}>
                                <div className="ps-5">
                        ...
                        <Link to="/skill-set">
                            <div className={`${Styles.itemClickable} ${currentPath === '/skill-set' ? Styles.open : ''}`}>
                                <div className="ps-5">
                        ...
                        <Link to="/past-work">
                            <div className={`${Styles.itemClickable} ${currentPath === '/past-work' ? Styles.open : ''}`}>
                                <div className="ps-5">
                        ...
                        <Link to="/activities">
                            <div className={`${Styles.itemClickable} ${currentPath === '/activities' ? Styles.open : ''}`}>
                                <div className="ps-5">
                        ...
                        <Link to="/contact">
                            <div className={`${Styles.itemClickable} ${currentPath === '/contact' ? Styles.open : ''}`}>
                                <div className="ps-5">
