...
export default function Tabs() {
    ...
    return (
        <div className={`d-flex`}>
            <Link to="/profile">
                <div className={`${Styles.tab} ${currentPath === '/profile' ? Styles.open : ''}`}>
            ...
            <Link to="/skill-set">
                <div className={`${Styles.tab} ${currentPath === '/skill-set' ? Styles.open : ''}`}>
            ...
            <Link to="/past-work">
                <div className={`${Styles.tab} ${currentPath === '/past-work' ? Styles.open : ''}`}>
            ...
            <Link to="/activities">
                <div className={`${Styles.tab} ${currentPath === '/activities' ? Styles.open : ''}`}>
            ...
            <Link to="/contact">
                <div className={`${Styles.tab} ${currentPath === '/contact' ? Styles.open : ''}`}>
