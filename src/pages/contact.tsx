            ...
            <div className={`row justify-content-center ${Styles.contact}`}>
                <div className="col-12 col-md-2">
                    <div className={Styles.bigIcon}>
                        <a href="https://twitter.com/TM_progapp" target="_blank" rel="noreferrer noopener">
                ...
                <div className="col-12 col-md-2">
                    <div className={Styles.bigIcon}>
                        <a href="mailto:tansantktk@hotmail.co.jp" target="_blank" rel="noreferrer noopener">
                ...
                <div className="col-12 col-md-2">
                    <div className={Styles.bigIcon}>
                        <a href="https://github.com/TansanMilMil" target="_blank" rel="noreferrer noopener">
