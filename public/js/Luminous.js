      ...
      (s.prototype.M = function (t) {
        ...
        (s.prototype.ba = function () {
          (this.c = document.createElement("div")),
            a(this.c, this.b("lightbox")),
            (this.f = document.createElement("div")),
            a(this.f, this.b("lightbox-inner")),
            this.c.appendChild(this.f);
          var t = document.createElement("div");
          a(t, this.b("lightbox-loader")),
            this.f.appendChild(t),
            (this.H = document.createElement("div")),
            a(this.H, this.b("lightbox-image-wrapper")),
            ...
            a(this.l, this.b("lightbox-caption")),
            t.appendChild(this.l),
            this.a.w &&
              ((this.G = document.createElement("div")),
              a(this.G, this.b("close-button")),
